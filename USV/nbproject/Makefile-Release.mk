...
${OBJECTDIR}/AllPthreadCreate.o: AllPthreadCreate.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AllPthreadCreate.o AllPthreadCreate.c

${OBJECTDIR}/AutoPilotThread.o: AutoPilotThread.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AutoPilotThread.o AutoPilotThread.c

${OBJECTDIR}/CanbusDataHandleThread.o: CanbusDataHandleThread.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CanbusDataHandleThread.o CanbusDataHandleThread.c

${OBJECTDIR}/SerialDataHandleThread.o: SerialDataHandleThread.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SerialDataHandleThread.o SerialDataHandleThread.c
...
${OBJECTDIR}/TakingSampleByRemoteThread.o: TakingSampleByRemoteThread.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TakingSampleByRemoteThread.o TakingSampleByRemoteThread.c
